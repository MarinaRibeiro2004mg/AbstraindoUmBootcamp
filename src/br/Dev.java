...
public class Dev {
    private String nome;
    private Set<Conteudo> conteudoInscritos = new LinkedHashSet<>(); // add apenas uma vez ao conteudo inscrito
    ...
    public void progredir() {
        ...
        if (conteudo.isPresent()) {
            ...
            System.out.println("Você ainda não se inscreveu para os conteudos da plataforma");
        }
    }
